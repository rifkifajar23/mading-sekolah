...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 13, 2022 at 06:13 AM
...
INSERT INTO `komentar` (`komentar_id`, `berita_id`, `nama`, `komentar`, `post`) VALUES
('177d779d-6b0e-4d57-8886-f51a569e3699', '32447057-7967-4d61-a709-e400af41b9f1', 'wkwk', 'kocak', '1657621865');
...
('4d3d9961-f3ae-4886-b318-bd133e373ce2', '(021) 789-456', 'smkplus.assaadah@gmail.com.', 'smkplus.assaadah 2', 'JL. RAYA RAWA KIDANG RT 14 RW 03, Kosambi, Kec. Sukadiri, Kab. Tangerang, Banten, dengan kode pos 15528.');
...
('668b92df-b4d5-468e-ba87-a438aef68830', 'SMK PLUS MULTIMEDIA AS-SAADAH 2', '<p>SMK PLUS MULTIMEDIA AS-SAADAH 2 adalah salah satu satuan pendidikan dengan jenjang SMK di Kosambi, Kec. Sukadiri, Kab. Tangerang, Banten . Menciptakan Lulusan yang Berkompeten dan Siap Kerja</p>\r\n\r\n<p>SMK BISA-HEBAT. Siap Kerja - Santun - Kreatif</p>\r\n', 'http://localhost/School-website/assets/img/opening word/my.JPG'),
('c010ad2f-7a6c-440a-a9de-a6414ede44e6', 'SMK PLUS MULTIMEDIA AS-SAADAH 2', '<p>SMK PLUS MULTIMEDIA AS-SAADAH 2 adalah salah satu satuan pendidikan dengan jenjang SMK di Kosambi, Kec. Sukadiri, Kab. Tangerang, Banten . Menciptakan Lulusan yang Berkompeten dan Siap Kerja</p>\r\n\r\n<p>SMK BISA-HEBAT. Siap Kerja - Santun - Kreatif</p>\r\n', 'http://localhost/School-website/assets/img/opening word/my.JPG');
...
('07155353-13cc-488b-82e4-d01536627098', 'prisko', 'prisko', '$2y$10$rnHLjt4l3As8QAu/VTRhYuszVCQudI9yFy/I.54sERS1DipOMSRzS', 'operator', '1657685350'),
('82829b15-de76-4cfd-9d32-7939584c70a5', 'reza', 'reza', '$2y$10$VLfbO01GIagiidlHYqLU5eaSvZ46XkZ8V/.KOs/pe0H9ULHS4p/Nu', 'superAdmin', '1657685418'),
('d46d5ae1-7b5a-4594-a9f2-cbf9376be135', 'dian', 'dian', '$2y$10$AVOsSP6fJCnI0O9FYz0bmOQ1sZMyysiimg/dBXlz8psIxmAztK46O', 'admin', '1657621817'),
('7ae4e066-c6b6-4ab8-a6a8-7cfa94af1ac5', 'osis', 'osis', 'osis', 'operator', '');
...
('be7c3e96-a39a-4a00-931e-96dd08a9ae8d', '<p><span style=\"font-size:12pt\"><span style=\"font-family:&quot;Times New Roman&quot;,serif\">Aktif dalam belajar Sehat dalam pikiran Sopan dalam kelakuan Amanah dalam tugas yang diemban Al-qur&rsquo;an dan sunnah sebagai pedoman Disiplin dalam kehidupan Ahli dalam ilmu agama dan pengetahuan Hormat dalam hubungan kemasyarakatan.</span></span></p>\r\n', '<p style=\"margin-left:0mm; margin-right:0mm; text-align:justify\"><span style=\"font-size:12pt\"><span style=\"font-family:&quot;Times New Roman&quot;,serif\">Mendidik generasi islami yang beriman, Berilmu dan berakhlak mulia, Serta bermanfaat bagi kehidupannya dan masyarakat Dengan mengimplementasikan ilmu ilmiah dan amal amaliah.</span></span></p>\r\n');
